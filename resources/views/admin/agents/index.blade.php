    ...
    <div class="lg:pl-64">
        ...
        <div class="p-6">
            ...
            <div class="mb-6 flex items-center justify-between">
                ...
                <a href="{{ route('admin.agents.create') }}" class="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-3 rounded-lg hover:from-blue-600 hover:to-purple-700 transition transform hover:scale-105 shadow-lg">
